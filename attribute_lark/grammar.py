...
class Symbol(Serialize):
    ...
    def __init__(self, name: str, code: str = "") -> None:
        ...
        if not code:
            ...
            try:
                ...
                raise SyntaxError(
                    "The attribute is not a valid python expression: %r" % code.lstrip()
                )
    ...
    def __eq__(self, other):
        ...
        return (
            self.is_term == other.is_term
            and self.name == other.name
            and self.ast == self.ast
        )
...
class Terminal(Symbol):
    ...
    def renamed(self, f):
        return type(self)(
            f(self.name), self.filter_out, ast.unparse(self.ast) if self.ast else ""
        )
...
class Rule(Serialize):
    ...
    ast : ast expression for the synthesized attribute
    """
