...
from attribute_lark import Tree, Transformer
from attribute_lark.exceptions import MissingVariableError
...
class TemplateConf:
    ...
    def _match_tree_template(
        ...
        assert isinstance(template, Tree) and isinstance(tree, Tree), (
